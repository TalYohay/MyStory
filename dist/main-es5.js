    ...
    var StoryService = /*#__PURE__*/function () {
      ...
      _createClass(StoryService, [{
        ...
        value: function getStoryById(id) {
          ...
          return this.http.get("/stories/story/".concat(id), httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res['story'];
          }));
        }
      }, {
        ...
        value: function deleteStory(id) {
          ...
          return this.http["delete"]("stories/story/".concat(id), httpOptions);
        }
      }, {
        key: "createStory",
        ...
        value: function updateStory(id, data) {
          ...
          return this.http.put("stories/edit/".concat(id), data, httpOptions);
        }
      }]);
    ...
    var UserService = /*#__PURE__*/function () {
      ...
      _createClass(UserService, [{
        ...
        value: function googleLogin() {
          return this.http.get("/auth/google"); // this.router.navigate([`${this.uri}/auth/google`])
        }
      }, {
        key: "Signup",
        ...
        value: function getUserById(id) {
          ...
          return this.http.get("/user/".concat(id), httpOptions); // .pipe(map(res => res['user']))
        }
      }, {
        ...
        value: function getProfileStories() {
          ...
          return this.http.get("/profile/mystories", httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            return res['Stories'];
          }));
        }
      }, {
